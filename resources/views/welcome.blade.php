        ...
        <section class="py-20 bg-beige-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <span class="inline-flex items-center gap-2 px-4 py-1.5 bg-beige-200/60 rounded-full text-sm font-medium text-beige-600 mb-4">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="section-subtitle mx-auto">Los favoritos de nuestros clientes esta semana</p>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    @foreach ($masVendidos as $producto)
                        <a href="{{ route('catalogo.show', $producto) }}" class="product-card group relative">
                            <div class="absolute -top-2 -right-2 w-8 h-8 bg-beige-600 rounded-full flex items-center justify-center shadow-lg z-10">
